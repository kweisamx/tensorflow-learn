...
y_data = x_data*0.1 + 0.3 ## the true function  y = x* 0.1 +0.3


''' create tensorflow structure start'''
# We know the w = 0.1 and b = 0.3 ,
# but we want to that tf to figure out the number
Weights = tf.Variable(tf.random_uniform([1], -1000.0 , 1000.0 )) # create 1 dimension , range in (-1,1) ,tf.Variable is a variable
